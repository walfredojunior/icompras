...
metadata: 
  ...
  modified: 2026-08-05T22:30:51.464Z
---

Estado em **2026-08-05**. Os detalhes de cada item estão em [[icompras-projeto]], na seção do dia em que o assunto apareceu.
...
2. **Senha do admin é `[SENHA-ADMIN-REMOVIDA]`** em produção — confirmado ENTRANDO com ela em 03/08. Um minuto dele em Admin › Trocar senha. É a que mais reduz risco.
3. **Google Search Console** — exige a conta Google dele. Sem isso ficamos cegos sobre indexação, e o gargalo do site é gente entrando.
...
- **Proxy / VPN / IP rotativo** para o coletor (discutido a fundo em 01/08 e 02/08; ele aceitou paralelizar sem se esconder).
...
- **Bloqueio total por país** na Cloudflare — descartado porque tiraria o site do Google (a regra que ele queria era desafio, e em 02/08 confirmei que o Googlebot passa).
